...
const UnionContent = ({isMobile}) => {
    ...
    return (
        <>
            ...
            {/* Section 2 */}
            {!isMobile &&
            <Wrapper height={780} bgColor={colors.deepWhite} isMobile={isMobile}>
                <Content>
            ...
            {/* Section 3 */}
            <Wrapper height={620} id="conference">
            ...
            {/* Section 4 */}
            <Wrapper height={734} bgColor={colors.deepWhite} id="onAir">
                <Content flexDirection={"column"}>
            ...
            {/* Section 5 */}
            <Wrapper height={620} id="linkBinder">
            ...
            {/* Section 6 */}
            <Wrapper height={584} bgColor={colors.deepWhite} id="uploadVideo">
            ...
            {/* Section 7 */}
            <Wrapper height={620} id="shoppingMall">
            ...
            {/* Section 8 */}
            <Wrapper height={462} bgImage={content8}>
                <Content flexDirection={"column"}>
